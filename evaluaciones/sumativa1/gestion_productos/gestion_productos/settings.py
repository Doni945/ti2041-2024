...
SECRET_KEY = 'django-insecure--k$(q+q709@sh49q0oj=1+qdek&gvgbtu2k68ymt75i7$^td=b'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'productos' / 'templates'],  # Agrega esta línea
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
TIME_ZONE = 'America/Santiago'  # Ajusta esto según tu zona horaria
...
STATICFILES_DIRS = [
    BASE_DIR / 'static',
    BASE_DIR / "static/images",  # Ruta específica a la carpeta de imágenes
]
